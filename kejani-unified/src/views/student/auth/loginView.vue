<template>
  <main class="w-full max-w-md mx-auto p-6">
    <div
      class="max mt-7 bg-white border border-gray-200 rounded-xl shadow-sm dark:bg-neutral-900 dark:border-neutral-700"
    >
...
const handleSubmit = () => {
  authStore.loginWithEmail(email.value, password.value)
  router.push('/console')
}
</script>
