      ...
      <div class="-m-1.5 overflow-x-auto">
        <div class="p-1.5 min-w-full inline-block align-middle">
          ...
          >
            ...
            >
              <div>
                <h2 class="text-xl font-semibold text-gray-800 dark:text-neutral-200">API Keys</h2>
                ...
                <tr>
                  ...
                  <td class="size-px whitespace-nowrap">
                    <div class="px-6 py-3">
                      <div class="flex items-center gap-x-2">
                        <span
                          class="inline-flex items-center justify-center size-6 rounded-full bg-gray-300 dark:bg-neutral-700"
                        >
                          <span
                            class="text-xs font-medium text-gray-800 leading-none dark:text-neutral-200"
                            >A</span
                          >
                        </span>
                        <div class="grow">
...
<script setup>
import addVue from '@/components/admin/add.vue'
</script>
